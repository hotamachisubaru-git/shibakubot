...
export const DEFAULT_SBK_MAX_REASON_LENGTH = 1_000;
export const MAX_SBK_MAX_REASON_LENGTH = 1_500;
export const DEFAULT_FILE_PORT = 3001;
export const DEFAULT_FILE_HOST = "127.0.0.1";
export const DEFAULT_FILE_DIR = "./files";
export const DEFAULT_MUSIC_PREFIX = "p!";
export const DEFAULT_MUSIC_INITIAL_VOLUME = 20;
export const DEFAULT_MUSIC_MAX_TRACK_MINUTES = 15;
export const DEFAULT_MUSIC_UPLOAD_MAX_MB = 25;
...
export const DEFAULT_YT_DLP_MAX_FILESIZE_MB = 100;
export const DEFAULT_YT_DLP_TEMP_MAX_AGE_HOURS = 24;
export const DEFAULT_YT_DLP_CLEANUP_INTERVAL_MINUTES = 6 * 60;
